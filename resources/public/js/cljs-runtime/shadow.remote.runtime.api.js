...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33017 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33017(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_33018 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_33018(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_33019 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_33019(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_33020 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_33020(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33027 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33027(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33028 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_33028(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__33002,callback){
var map__33003 = p__33002;
var map__33003__$1 = cljs.core.__destructure_map(map__33003);
var input = map__33003__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33003__$1,new cljs.core.Keyword(null,"code","code",1586293142));
