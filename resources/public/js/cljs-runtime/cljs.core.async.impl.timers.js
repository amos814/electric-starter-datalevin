...
var i_33144 = (0);
while(true){
if((i_33144 < arr.length)){
(arr[i_33144] = null);

var G__33146 = (i_33144 + (1));
i_33144 = G__33146;
continue;
} else {
}
...
var i_33157 = (self__.level + (1));
while(true){
if((i_33157 <= (new_level + (1)))){
(update[i_33157] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_33159 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_33159[i]));
} else {
x__$2.forward.push((((i < links_33159.length))?(links_33159[i]):null));
}

if((i < links_33159.length)){
(links_33159[i] = x__$2);
} else {
links_33159.push(x__$2);
}
...
if((x__$1 === (((i_33161 < links_33162.length))?(links_33162[i_33161]):null))){
