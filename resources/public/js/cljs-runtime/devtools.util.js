...
var _STAR_print_newline_STAR__orig_val__30163_30364 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__30164_30365 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__30165_30366 = true;
var _STAR_print_fn_STAR__temp_val__30166_30367 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__30165_30366);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__30166_30367);

try{var _STAR_print_level_STAR__orig_val__30167_30368 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30168_30369 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30168_30369);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30167_30368);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__30164_30365);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__30163_30364);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq30153){
...
var new_formatters = current_formatters.filter((function (p1__30255_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__30255_SHARP_)));
}));
...
var G__30257_30394 = f;
var target__27766__auto___30395 = G__30257_30394;
if(cljs.core.truth_(target__27766__auto___30395)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30257_30394)].join(''),"\n","target__27766__auto__"].join('')));
}

(target__27766__auto___30395["toString"] = (function (){
...
var G__30260_30397 = "%c%s";
var G__30261_30398 = "color:transparent";
var G__30262_30399 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__30260_30397,G__30261_30398,G__30262_30399) : f.call(null,G__30260_30397,G__30261_30398,G__30262_30399));
...
var vec__30289 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30289,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30289,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__30406__delegate = function (add_fmt,add_args){
...
var G__30406 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__30408__i = 0, G__30408__a = new Array(arguments.length -  1);
while (G__30408__i < G__30408__a.length) {G__30408__a[G__30408__i] = arguments[G__30408__i + 1]; ++G__30408__i;}
  add_args = new cljs.core.IndexedSeq(G__30408__a,0,null);
} 
return G__30406__delegate.call(this,add_fmt,add_args);};
G__30406.cljs$lang$maxFixedArity = 1;
G__30406.cljs$lang$applyTo = (function (arglist__30409){
var add_fmt = cljs.core.first(arglist__30409);
var add_args = cljs.core.rest(arglist__30409);
return G__30406__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq30269){
var G__30270 = cljs.core.first(seq30269);
var seq30269__$1 = cljs.core.next(seq30269);
var G__30271 = cljs.core.first(seq30269__$1);
var seq30269__$2 = cljs.core.next(seq30269__$1);
var G__30272 = cljs.core.first(seq30269__$2);
var seq30269__$3 = cljs.core.next(seq30269__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30270,G__30271,G__30272,seq30269__$3);
}));
...
var seq__30303 = cljs.core.seq(features);
var chunk__30304 = null;
var count__30305 = (0);
var i__30306 = (0);
while(true){
if((i__30306 < count__30305)){
var feature = chunk__30304.cljs$core$IIndexed$_nth$arity$2(null,i__30306);
...
var G__30411 = seq__30303;
var G__30412 = chunk__30304;
var G__30413 = count__30305;
var G__30414 = (i__30306 + (1));
seq__30303 = G__30411;
chunk__30304 = G__30412;
count__30305 = G__30413;
i__30306 = G__30414;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__30303);
if(temp__5804__auto__){
var seq__30303__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__30303__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__30303__$1);
var G__30415 = cljs.core.chunk_rest(seq__30303__$1);
var G__30416 = c__5568__auto__;
var G__30417 = cljs.core.count(c__5568__auto__);
var G__30418 = (0);
seq__30303 = G__30415;
chunk__30304 = G__30416;
count__30305 = G__30417;
i__30306 = G__30418;
continue;
} else {
var feature = cljs.core.first(seq__30303__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__30419 = cljs.core.next(seq__30303__$1);
var G__30420 = null;
var G__30421 = (0);
var G__30422 = (0);
seq__30303 = G__30419;
chunk__30304 = G__30420;
count__30305 = G__30421;
i__30306 = G__30422;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o30352 = temp__5802__auto__;
return (o30352["version"]);
} else {
return null;
}
})() == null);
