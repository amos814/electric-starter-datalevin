...
var vec__36910 = cljs.math.setup_hl(ix,hx__$1,lx);
var hx__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36910,(0),null);
var lx__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36910,(1),null);
var vec__36913 = cljs.math.setup_hl(iy,hy__$1,ly);
var hy__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36913,(0),null);
var ly__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36913,(1),null);
var vec__36916 = (function (){var n = (ix - iy);
var hx__$3 = hx__$2;
var lx__$2 = lx__$1;
while(true){
if((n === (0))){
...
var vec__36933 = (((hz < (0)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((hx__$3 + hx__$3) + (lx__$2 >>> (31))),(lx__$2 + lx__$2)], null):((((hz | lz) === (0)))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("Signed zero",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"zero","zero",-858964576),true], null))})():new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((hz + hz) + (lz >>> (31))),(lz + lz)], null)));
var hx__$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36933,(0),null);
var lx__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36933,(1),null);
var G__37474 = (n - (1));
var G__37475 = ((4294967295) & hx__$4);
var G__37476 = ((4294967295) & lx__$3);
n = G__37474;
hx__$3 = G__37475;
lx__$2 = G__37476;
continue;
...
var hx__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36916,(0),null);
var lx__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36916,(1),null);
var hz = ((cljs.math.u_LT_(lx__$2,ly__$1))?((hx__$3 - hy__$2) - (1)):(hx__$3 - hy__$2));
var lz = (lx__$2 - ly__$1);
var vec__36919 = (((hz >= (0)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hz,lz], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hx__$3,lx__$2], null));
var hx__$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36919,(0),null);
var lx__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36919,(1),null);
...
var vec__36922 = (function (){var hx__$5 = hx__$4;
var lx__$4 = lx__$3;
var iy__$1 = iy;
while(true){
if((!((hx__$5 < (1048576))))){
...
var G__37477 = ((hx__$5 + hx__$5) + (lx__$4 >>> (31)));
var G__37478 = (lx__$4 + lx__$4);
var G__37479 = (iy__$1 - (1));
hx__$5 = G__37477;
lx__$4 = G__37478;
iy__$1 = G__37479;
continue;
...
var hx__$5 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36922,(0),null);
var lx__$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36922,(1),null);
var iy__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36922,(2),null);
if((iy__$1 >= (-1022))){
...
var n = ((-1022) - iy__$1);
var vec__36949 = (((n <= (20)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(hx__$5 >> n),((lx__$4 >>> n) | (hx__$5 << ((32) - n)))], null):(((n <= (31)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sx,((hx__$5 << ((32) - n)) | (lx__$4 >>> n))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sx,(hx__$5 >> (n - (32)))], null)
));
var hx__$6 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36949,(0),null);
var lx__$5 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36949,(1),null);
(i[cljs.math.HI_x] = (hx__$6 | sx));
...
var vec__37393 = ((((ht & (2147483648)) === (0)))?cljs.math.add64(ht,lt,(4294967295),(4294967295)):cljs.math.add64(ht,lt,(0),(1)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37393,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37393,(1),null);
(i[cljs.math.HI] = hr);
...
var ht = (i[cljs.math.HI]);
var lt = (i[cljs.math.LO]);
var vec__37412 = ((((ht & (2147483648)) === (0)))?cljs.math.add64(ht,lt,(0),(1)):cljs.math.add64(ht,lt,(4294967295),(4294967295)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37412,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37412,(1),null);
(i[cljs.math.HI] = hr);
...
var ht = (i[cljs.math.HI]);
var lt = (i[cljs.math.LO]);
var vec__37425 = (((d > (0)))?cljs.math.add64(ht,lt,(4294967295),(4294967295)):cljs.math.add64(ht,lt,(0),(1)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37425,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37425,(1),null);
(i[cljs.math.HI] = hr);
...
var G__37537 = (d__$1 * exp_delta);
var G__37538 = (scale_factor__$1 - scale_increment);
d__$1 = G__37537;
scale_factor__$1 = G__37538;
continue;
}
break;
}
